...
public partial class QuanLyBanSachContext : DbContext
{
    ...
    public virtual DbSet<TKhuyenMai> TKhuyenMais { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-QUC01RN\\SQLEXPRESS;Initial Catalog=QuanLyBanSach;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TKhuyenMai>(entity =>
        {
            entity.HasKey(e => e.MaKm);

            entity.ToTable("tKhuyenMai");
        ...
        modelBuilder.Entity<TSach>(entity =>
        {
            ...
            entity.HasOne(d => d.MaKmNavigation).WithMany(p => p.TSaches)
                .HasForeignKey(d => d.MaKm)
                .HasConstraintName("FK_tSach_tKhuyenMai");
